...
void update_price(double baseprice, double discountpercentage){
    ...
    double discount = (this->price * discountpercentage) / 100;  // Calculate discount
    this->price -= discount;  // Apply discount to the price
...
int main(){
 ...
 cout<<"final price after disvount is :"<<b1.getprice()<<endl;
